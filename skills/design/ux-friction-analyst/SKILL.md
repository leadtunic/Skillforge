...
description: Find UX friction in flows, forms, dashboards, onboarding, and admin interfaces.
category: design
version: 1.0.0
---
...
Find UX friction in flows, forms, dashboards, onboarding, and admin interfaces.
...
1. Identify unclear labels, missing states, and unnecessary steps.
2. Review information hierarchy and visual priority.
3. Check empty, loading, error, and success states.
4. Find mismatches between user intent and system language.
5. Recommend pragmatic improvements with expected impact.
